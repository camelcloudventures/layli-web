...
import { mockUsers } from "./mock-schedules"
...
const mockIssueComments: IssueComment[] = [
  ...
  },
  {
    ...
    text: "Thanks, Sarah. I'll follow up with the maintenance team to ensure the guardrails are properly installed.",
  ...
  },
  {
    ...
    text: "I've reviewed the compliance gaps and created an action plan to address them.",
...
export const mockIssues: Issue[] = [
  {
    ...
    comments: mockIssueComments.filter((comment) => comment.issue_id === "issue-1"),
  },
  {
    id: "issue-2",
    ...
    comments: mockIssueComments.filter((comment) => comment.issue_id === "issue-2"),
  },
  {
    id: "issue-3",
  ...
  },
  {
    ...
    description: "The monthly inspection of fire extinguishers in the east wing is overdue by 15 days.",
    category: "safety",
    priority: "medium",
    status: "resolved",
    reporter_id: "user-2",
